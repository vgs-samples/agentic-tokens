...
const DEFAULTS = {
  ...
  hero: {
    badge: "Новинка",
    headlineLines: ["Сделано", "с любовью —", "для вас"],
    tagline: "Новый продукт, созданный специально для вас.",
    primaryCta: "Узнать больше",
    secondaryCta: "Посмотреть детали",
    usps: ["Высокое качество", "Быстро", "Надёжно"],
  },
  stats: [
  ...
  about: {
    eyebrow: "О нас",
    headlineLines: ["Мы делаем то,", "во что верим"],
    paragraphs: [
      "Наша команда работает над тем, чтобы каждый клиент получил лучшее.",
      "Каждый день мы стремимся быть лучше — и это видно в нашей работе.",
    ],
    miniCards: [
      { icon: "✨", title: "Качество", subtitle: "В каждой детали" },
      { icon: "💎", title: "Надёжность", subtitle: "Проверено временем" },
    ],
  },
  why: {
    eyebrow: "Почему мы?",
    headline: "Разница — в подходе",
    features: [
      { icon: "⚡", title: "Скорость", body: "Мы делаем быстро, не теряя в качестве." },
      { icon: "🛡️", title: "Безопасность", body: "Ваши данные под надёжной защитой." },
      { icon: "🎯", title: "Точность", body: "Никаких компромиссов в результате." },
      { icon: "💰", title: "Честные цены", body: "Платите только за то, что получаете." },
      { icon: "🎁", title: "Бонусы", body: "Лояльные клиенты получают больше." },
      { icon: "❤️", title: "Забота", body: "Мы всегда на связи и готовы помочь." },
    ],
  },
  prices: {
    eyebrow: "Наши тарифы",
    headline: "Выберите подходящий план",
    subtitle: "Прозрачные цены, без скрытых платежей",
    popularBadge: "ХИТ",
    tiers: [
      {
        icon: "🌱", name: "Старт", subtitle: "Для пробы",
        price: "500₽", unit: "/мес",
        bullets: ["Базовый функционал", "Email-поддержка", "До 5 проектов"],
        cta: "Выбрать",
      },
      {
        icon: "🚀", name: "Профи", subtitle: "Самый популярный",
        price: "1 500₽", unit: "/мес",
        bullets: ["Всё из Старта", "Приоритетная поддержка", "Без лимита проектов", "Расширенная аналитика"],
        cta: "Выбрать",
      },
      {
        icon: "💎", name: "Бизнес", subtitle: "Для команд",
        price: "5 000₽", unit: "/мес",
        bullets: ["Всё из Профи", "Персональный менеджер", "API-доступ", "Кастомизация"],
        cta: "Связаться",
      },
    ],
  },
  reviews: {
    ...
    items: [
      { text: "Отличный сервис, рекомендую всем!", initial: "М", name: "Мария К.", city: "Москва" },
      { text: "Качество на высоте, поддержка отвечает быстро.", initial: "А", name: "Андрей П.", city: "Санкт-Петербург" },
      { text: "Использую уже год — ни разу не подвели.", initial: "Е", name: "Елена С.", city: "Казань" },
    ],
  },
  order: {
    eyebrow: "Связаться с нами",
    headlineLines: ["Готовы начать?", "Оставьте заявку"],
    subtitle: "Перезвоним в течение 30 минут",
    nameLabel: "Ваше имя",
    namePlaceholder: "Иван Иванов",
    phoneLabel: "Телефон",
    phonePlaceholder: "+7 (999) 000-00-00",
    quantityLabel: "Что вас интересует?",
    quantities: ["Стартовый план", "Профессиональный", "Бизнес", "Консультация", "Другое"],
    addressLabel: "Адрес",
    addressPlaceholder: "Город, улица, дом",
    timeLabel: "Удобное время",
    times: ["Утро (9:00–12:00)", "День (12:00–17:00)", "Вечер (17:00–21:00)"],
  ...
  footer: {
    tagline: "Делаем лучшее для наших клиентов каждый день.",
